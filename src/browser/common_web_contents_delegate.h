...
class MesonJavaScriptDialogManager;
class NativeWindow;
...
class CommonWebContentsDelegate
 ...
 public:
  ...
  // |web_contents|.
  void InitWithWebContents(content::WebContents* web_contents, MesonBrowserContext* browser_context);
  ...
  brightray::InspectableWebContents* managed_web_contents() const { return web_contents_.get(); }
 ...
 protected:
  ...
  content::ColorChooser* OpenColorChooser(content::WebContents* web_contents, SkColor color, const std::vector<content::ColorSuggestion>& suggestions) override;
  void RunFileChooser(content::RenderFrameHost* render_frame_host, const content::FileChooserParams& params) override;
  void EnumerateDirectory(content::WebContents* web_contents, int request_id, const base::FilePath& path) override;
  ...
  void DevToolsIndexPath(int request_id, const std::string& file_system_path) override;
...
// brightray::InspectableWebContentsViewDelegate:
 ...
 private:
  ...
  std::unique_ptr<MesonJavaScriptDialogManager> dialog_manager_;
  ...
  typedef std::map<int, scoped_refptr<DevToolsFileSystemIndexer::FileSystemIndexingJob>> DevToolsIndexingJobsMap;
