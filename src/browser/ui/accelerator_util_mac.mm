...
void SetPlatformAccelerator(ui::Accelerator* accelerator) {
  ...
  ui::MacKeyCodeForWindowsKeyCode(accelerator->key_code(), modifiers, &character, &characterIgnoringModifiers);
  ...
  std::unique_ptr<ui::PlatformAccelerator> platform_accelerator(new ui::PlatformAcceleratorCocoa(characters, modifiers));
