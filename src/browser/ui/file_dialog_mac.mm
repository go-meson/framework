...
void SetupDialog(NSSavePanel* dialog, const std::string& title, const std::string& button_label, const base::FilePath& default_path, const Filters& filters) {
  if (!title.empty())
...
int RunModalDialog(NSSavePanel* dialog, meson::NativeWindow* parent_window) {
