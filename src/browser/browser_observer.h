...
class BrowserObserver {
 public:
  ...
  virtual void OnLogin(LoginHandler* login_handler, const base::DictionaryValue& request_details) {}
  ...
  virtual void OnContinueUserActivity(bool* prevent_default, const std::string& type, const base::DictionaryValue& user_info) {}
#endif
